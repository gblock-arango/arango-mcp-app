...
class GatewayArangoClient:
    ...
    This is the low-level **request/response** channel (including auth to the gateway).
    ...
    def __init__(self, gateway: GatewaySettings) -> None:
    ...
    def connect(self) -> None:
        ...
        base = self._base()
        if not base:
            raise ValueError("ARANGO_GATEWAY_BASE_URL is required for gateway mode")
