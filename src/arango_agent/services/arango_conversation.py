...
and normalizes the response like :func:`arango_agent.services.genie_conversation` consumers expect.
...
def ask_arango_conversation(
    *,
    ...
    stub = (
        "Arango AI (stub): received your message (ADA mode). On **arango-agent** set env "
