...
startup runs ``refresh_genie_space_id_in_app`` (same idea as flask-arango-agent ``GENIE_AUTO_PROVISION``).
"""
...
from arango_agent.services.registry_types import RegistryTableRef, parse_fqn_table
...
def reconcile_genie_uc_registry_for_dashboard_app(app: Any) -> dict[str, Any]:
    ...
    """
    from arango_agent.services.genie_workspace_client import running_in_databricks_app
