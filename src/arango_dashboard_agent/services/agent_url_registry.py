"""Unity Catalog registry for the deployed arango-mcp-app public base URL (same pattern as gateway)."""
...
from arango_dashboard_agent.services.registry_types import parse_fqn_table
...
def publish_self_agent_url_to_uc_if_configured(app: Any) -> None:
    ...
    try:
        ...
        logger.info("Published arango-mcp-app base URL to UC table %s", table)
    except Exception as exc:
